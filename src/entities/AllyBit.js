...
export function createAllyMeleeBit(world, x, y) {
  ...
  bit.addTrait('Health', new Health(80));
  ...
  bit.addTrait('AttackTarget', new AttackTarget(50, 1500, 3.75)); // 攻撃範囲50、クールダウン1.5秒、攻撃力3.75
...
export function createAllyRangedBit(world, x, y) {
  ...
  bit.addTrait('Position', new Position(x, y, 0, 0));
  bit.addTrait('Health', new Health(60)); // HPは低め
